...
public class Affine2{
    ...
    public Affine2 set(GdxMatrix4 matrix){
        float[] other=matrix.val;

        m00=other[GdxMatrix4.M00];
        m01=other[GdxMatrix4.M01];
        m02=other[GdxMatrix4.M03];
        m10=other[GdxMatrix4.M10];
        m11=other[GdxMatrix4.M11];
        m12=other[GdxMatrix4.M13];
        return this;
    }
    ...
    public Affine2 setToRotation(float degrees){
        float cos=(float)Math.cos(degrees*Maths.toRadians);
        float sin=(float)Math.sin(degrees*Maths.toRadians);
    ...
    public Affine2 setToRotationRad(float radians){
        float cos=(float)Math.cos(radians*Maths.toRadians);
        float sin=(float)Math.sin(radians*Maths.toRadians);
