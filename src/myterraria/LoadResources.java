...
import myterraria.interfaces.FrameBuffer;
import myterraria.interfaces.Item;
...
public class LoadResources{
    ...
    public static void loadResources(){
        ...
        Assets.loadTTF("fonts/standart.ttf","font5",8,new Color(0.5f,0.5f,0.5f,1));
        */
        //BACKGROUNDS
        ...
        Assets.loadTexture("projectiles/Projectile_132.png","Projectile_132");
    ...
    public static void defineTilesAndItems(TileManager tileManager){
        ...
        ItemManager.defineItem(new Item(7,new FrameBuffer().addFrame("Item_8"),0.35f).addTag("item_type",new Value<>("tile")).addTag("tile_id",new Value<>(140)));
        ...
        tileManager.addTileDataReg(140,0,"Tiles_4",24*0,24*1,20,20);
        tileManager.addTileDataReg(140,1,"Tiles_4",24*1,24*1,20,20);
        tileManager.addTileDataReg(140,2,"Tiles_4",24*2,24*1,20,20);
        tileManager.addTileDataReg(140,3,"Tiles_4",24*3,24*1,20,20);
        tileManager.addTileDataReg(140,4,"Tiles_4",24*4,24*1,20,20);
        tileManager.addTileDataReg(140,5,"Tiles_4",24*5,24*1,20,20);
